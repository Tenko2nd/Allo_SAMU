...
excel_path = "C:/Users/Awa Diop/Documents/E4 Eseo/projet de synthèse/Cas-AnonymeFINAL.xlsx"  # À adapter si besoin
        ...
        try:
            ...
            for id_idm, metadata in metadata_dict.items():
                if str(id_idm).lower() in file_lower:
                    ligne = f"{file}: [sexe: {metadata['sexe_normalized']}]\n"

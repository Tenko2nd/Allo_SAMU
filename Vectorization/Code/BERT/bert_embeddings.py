...
from Constant import bert_constant as c
...
if __name__ == "__main__":
    list_data_bert_dir = ["../../../Preprocessing/Results/BERT", "../../../Preprocessing/Results/BERT/raw"]
    ...
    for data_bert_dir in list_data_bert_dir:
        ...
        for model_name in list_model_name:
            ...
            for type_metadata in list_type_metadata:
                ...
                output_dir = f"../../Results/BERT/{model_name.split('/')[-1]}_{('_').join(data_bert_dir.split('_')[-1:])}_json"
